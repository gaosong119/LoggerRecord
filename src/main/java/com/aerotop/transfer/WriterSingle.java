...
public class WriterSingle {
    ...
    /**
     * @Description: 远程发送时为用户提供的debug级别的接口
     * @Author: gaosong
    ...
    /**
     * @Description: 本地记录时为用户提供的debug级别的接口
     * @Author: gaosong
     ...
     * @return: void
     **/
    public void loggerDebug(byte process, String event, String eventCount, String reserved) {
        Message message = new Message(instance.frameType, instance.sourceName, LogLevelEnum.debug, System.currentTimeMillis()
                , process, event, eventCount, reserved);
        logger(message, "");
    }
    /**
     * @Description: 远程发送时为用户提供的info级别的接口
     * @Author: gaosong
     * @Date: 2020/10/12 15:51
     * @param: process:流程,event:事件,eventCount:事件内容,reserved:备注,topic:主题
     * @return: * @return: null
    ...
    /**
     * @Description: 本地记录时为用户提供的info级别的接口
     * @Author: gaosong
     * @Date: 2020/11/23 9:14
     * @param process: 流程
     * @param event: 事件
     * @param eventCount: 事件内容
     * @param reserved: 备注
     * @return: void
     **/
    public void loggerInfo(byte process, String event, String eventCount, String reserved) {
        Message message = new Message(instance.frameType, instance.sourceName, LogLevelEnum.info, System.currentTimeMillis()
                , process, event, eventCount, reserved);
        logger(message,"");
    }
    /**
     * @Description: 远程发送时为用户提供的warn级别的接口
     * @Author: gaosong
     * @Date: 2020/10/12 15:51
     * @param: process:流程,event:事件,eventCount:事件内容,reserved:备注,topic:主题
     * @return: * @return: null
    ...
    /**
     * @Description: 本地记录时为用户提供的warn级别的接口
     * @Author: gaosong
     ...
     * @return: void
     **/
    public void loggerWarn(byte process, String event, String eventCount, String reserved) {
        Message message = new Message(instance.frameType, instance.sourceName, LogLevelEnum.warn, System.currentTimeMillis()
                , process, event, eventCount, reserved);
        logger(message, "");
    }
    /**
     * @Description: 远程发送时为用户提供的error级别的接口
     * @Author: gaosong
     * @Date: 2020/10/12 15:51
     * @param: process:流程,event:事件,eventCount:事件内容,reserved:备注,topic:主题
     * @return: * @return: null
    ...
    /**
     * @Description: 本地记录时为用户提供的error级别的接口
     * @Author: gaosong
     ...
     * @return: void
     **/
    public void loggerError(byte process, String event, String eventCount, String reserved) {
        Message message = new Message(instance.frameType, instance.sourceName, LogLevelEnum.error, System.currentTimeMillis()
                , process, event, eventCount, reserved);
        logger(message, "");
    }
     ...
     * @return: void
     **/
    private void logger(Message message, String topic) {
        //获取message日志级别属性
        ...
        if (messageLevel >= configLevel && configLevel != 4) {//>=配置级别执行存储
            ...
            } else if ("remote".equalsIgnoreCase(locationInterfaceSelector) && !"".equals(topic) && topic!=null) {//远程存储
                //按照协议组装消息
